 ...
 * $version: 1.5.0
 *
 * Modified by Marek saji Augustynowicz:
 *  * added ajax.endLoading callback
 */
jQuery(function($) {
	...
	function ajaxLoaded(data) {
        ...
        if (typeof currentSettings.ajax.endLoading == 'function')
            data = currentSettings.ajax.endLoading.call(this,data);
