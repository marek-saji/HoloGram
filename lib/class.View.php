...
class View extends HgBase implements IView
{
    ...
    public function __construct()
    {
        ...
        $this->_inl_jses[] = sprintf("/**\n * hg settings\n */\nvar hg_base = '%s'",
                g()->req->getBaseUri());
        $this->_inl_jses[] = "var hg_include_path = hg_base+'js/'";
        $this->_inl_jses[] = sprintf("var hg_app_ver = '%s'", @ g()->conf['version']);
        if (g()->debug->on('js'))
            $this->_inl_jses[] = "var hg_debug = true";
